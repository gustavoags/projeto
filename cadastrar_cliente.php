...
<body>
    <form method="POST" action="">
        <div class="tela-login">
            ...
            <input value="<?php if(isset($_POST['nome'])) echo $_POST['nome']; ?>" type="text" name="nome" placeholder="Nome" class="inputUser" >
            <br><br>
            <input value="<?php if(isset($_POST['email'])) echo $_POST['email']; ?>" type="text" name="email" placeholder="E-mail" class="inputUser" >
            <br><br>
